...
from sentiment_utils import (
    get_binary_sentiment,
    get_fine_grained_sentiment,
    get_all_emotions,
    get_emotions,
    binary_fine_grained_model,
    count_vect,
    tfidf_transformer,
    label_encoder,
)
...
def binary_sentiment():
    ...
    result = get_binary_sentiment(
        text=text,
        language="english",
        minWordLength=2,
        model=binary_fine_grained_model,
...
def fine_grained_sentiment():
    ...
    result = get_fine_grained_sentiment(
        text=text,
        language="english",
        minWordLength=2,
        model=binary_fine_grained_model,
